...
class cmb_Meta_Box_field {
	...
	public function repeatable_exception( $type ) {
		...
		return in_array( $type, array(
			...
			'title',
			'group',
			// SUSCRIPTFLECH Ajax load wp_editor: http://wordpress.stackexchange.com/questions/51776/how-to-load-wp-editor-through-ajax-jquery
			'wysiwyg',
			'checkbox',
			'radio_inline',
			'taxonomy_radio',
